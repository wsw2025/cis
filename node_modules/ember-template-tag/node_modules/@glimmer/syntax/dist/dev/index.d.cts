...
declare namespace src {
    ...
    const visitorKeys: {
        ...
        readonly ElementStartNode: readonly [
        ];
        readonly ElementPartNode: readonly [
        ];
        readonly ElementEndNode: readonly [
        ];
        readonly ElementNameNode: readonly [
        ];
...
declare namespace ASTv1 {
    ...
    interface ElementStartNode extends BaseNode {
        type: "ElementStartNode";
        value: string;
    }
    interface ElementNameNode extends BaseNode {
        type: "ElementNameNode";
        value: string;
    }
    interface ElementEndNode extends BaseNode {
        type: "ElementEndNode";
        value: string;
    }
    interface ElementPartNode extends BaseNode {
    ...
    */
     ...
     * {{#Foo as |bar|}}... bar is a BlockParam.
     */
    interface BlockParam extends BaseNode {
        type: "BlockParam";
        value: string;
    }
    interface StripFlags {
